...
img = imread(['D:/dataset/newFood_724_clean/saliency/tauhu_goreng/Tauhu_Goreng58.jpg']);
...
if online == 1
    ...
    net_weights = ['models/newFood724/imagenet_googlenetCAM_train_iter_160000.caffemodel'];
